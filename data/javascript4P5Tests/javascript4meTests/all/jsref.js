...
print("DEBUG at beginning is " + DEBUG);
...
print("DEBUG in testcase constructor is " + DEBUG);
...
function getTestCaseResult( expect, actual ) {
    ...
    //  a special compare to see if we got the right result.
        ...
        print( " expected: " + expect + " actual: " + actual);
    ...
    // need to replace w/ IEEE standard for rounding
        if (    !passed
                ...
                print( " IEEEE shit test " );
                if ( Math.abs(actual-expect) < 0.0000001 ) {
                print( " IEEEE shit math abs - this one doesnt work" );
                    passed = true;
                }
        }
...
println("writeHeaderToLog");

writeHeaderToLog( SECTION + " "+ TITLE);

var TEST_STRING = new String( " !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~" );

  print("start printing weird x numbers");
  print(0x0020);
  print(0x007e);
  print("end printing weird x numbers");
for ( j = 0, i = 0x0020; i < 0x007e; i++, j++ ) {
  println("adding a test case");
  AddTestCase(  "TEST_STRING.charCodeAt("+j+")", i, TEST_STRING.charCodeAt( j ) );
}

AddTestCase(  'TEST_STRING.charCodeAt('+i+')', NaN,    TEST_STRING.charCodeAt( i ) );
